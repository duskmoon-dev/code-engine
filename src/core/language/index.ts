export {language, Language, LRLanguage, sublanguageProp, defineLanguageFacet,
...
export {HighlightStyle, syntaxHighlighting, highlightingFor, defaultHighlightStyle} from "./highlight"
