...
import {Text, EditorSelection, EditorState} from "../state"
  ...
  constructor(private view: EditorView) {
    ...
    if (typeof IntersectionObserver == "function") {
      this.intersection = new IntersectionObserver(entries => {
        if (this.parentCheck < 0) this.parentCheck = setTimeout(this.listenForScroll.bind(this), 1000) as unknown as number
