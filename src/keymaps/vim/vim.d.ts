...
import { StringStream } from '../../core/language/index';
import { SearchQuery } from '../../core/search/index';
import { ChangeDesc, EditorSelection, Extension } from '../../core/state/index';
import { EditorView, ViewUpdate } from '../../core/view/index';
	...
	getVimGlobalState_: () => {
		...
		jumpList: ReturnType<() => {
			...
			move: (cm: CodeMirror, offset: number) => {
				...
				update(change: import("../../core/state/index").ChangeDesc): void;
			} | undefined;
		}>;
