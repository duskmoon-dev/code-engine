// @ts-nocheck
// [DUSKMOON] Vendored from @replit/codemirror-vim v6.3.0
// MIT License - Copyright (C) 2018-2021 by Marijn Haverbeke <marijnh@gmail.com> and others
// Import paths rewritten from @codemirror/* to vendored modules

import { EditorSelection, MapMode, Prec, StateEffect, RangeSetBuilder, StateField } from '../../core/state/index';
import { foldCode, matchBrackets, indentUnit, ensureSyntaxTree, StringStream } from '../../core/language/index';
import * as View from '../../core/view/index';
import { EditorView, runScopeHandlers, Direction, ViewPlugin, Decoration, showPanel } from '../../core/view/index';
import { SearchQuery, setSearchQuery, RegExpCursor } from '../../core/search/index';
import { indentMore, indentLess, cursorLineBoundaryBackward, cursorLineBoundaryForward, cursorCharBackward, indentSelection, insertNewlineAndIndent, cursorCharLeft, undo, redo } from '../../core/commands/index';
 ...
 */
  ...
  */
  ...
  class ExCommandDispatcher {
     ...
     * @param {import("../../core/language/index").StringStream} inputStream
    ...
    /**
     * @param {string | import("../../core/language/index").StringStream} inputStream
     * @param {number} line
     */
